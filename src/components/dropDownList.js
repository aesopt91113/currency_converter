    ...
    <div>
      ...
      <div className="text-center d-flex inline-block ml-4 mb-2 dropdown">
        ...
        <div className="dropdown-menu">
          {
            Object.keys(rates).map((key) => <a className="dropdown-item" onClick={changeBaseCurrency} key={key} >{key}</a>)
          }
        </div>
      ...
      <div className="text-center d-flex inline-block ml-4 dropdown">
        ...
        <div className="dropdown-menu">
          {
            Object.keys(rates).map((key) => <a className="dropdown-item" onClick={changeSecondaryCurrency} key={key}>{key}</a>)
          }
        </div>
